  ...
  return (
    <div className='admin-order-item'>
        ...
        <div className="col">
            ...
            <a className='underline text-medium' target='_blank' href={item.artwork}>Artwork File: <span>{item.artwork}</span> </a>
            <p className="text-medium">Imprint Colors: <span>{item.color}</span> </p>
            ...
            <p className="text-medium">Product Material:<span> {item.material}</span></p>
        </div>
    </div>
  )
}
