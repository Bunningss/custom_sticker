    ...
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route
          exact
          path="/login"
          element={!user.currentUser ? <Login /> : <MyAccount />}
        />
        <Route
          exact
          path="/register"
          element={!user.currentUser ? <Register /> : <MyAccount />}
        />
        <Route
          exact
          path="/forgot"
          element={!user.currentUser ? <Forgot /> : <MyAccount />}
        />
        <Route
          exact
          path="/reset/:id"
          element={!user.currentUser ? <Reset /> : <MyAccount />}
        />
        <Route
          exact
          path="/update"
          element={user.currentUser ? <UserInfo /> : <MyAccount />}
        />
